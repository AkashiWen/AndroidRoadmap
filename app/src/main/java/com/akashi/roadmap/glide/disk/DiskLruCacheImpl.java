package com.akashi.roadmap.glide.disk;
...
public class DiskLruCacheImpl {
    ...
    // TODO put
    public void put(String key, EngineResource value) {
//        Tool.checkNotEmpty(key);
    ...
    // TODO get
    public EngineResource get(String key) {
//        Tool.checkNotEmpty(key);
        ...
        try {
            ...
            if (null != snapshot) {
                EngineResource value = new EngineResource();
